...
def _construir_rede_hibrida(
    ...
    """
    Fase 13.3 Rev.3 — rede distribuída por caixas octogonais.
...
# ============================================================
# FASE 13.3 REV.3 — REDISTRIBUIÇÃO FÍSICA AUTOMÁTICA
# ============================================================
...
def _redistribuir_tronco_caixas_octogonais(
    ...
    """
    Fecha o ciclo da Fase 13.3 Rev.3:
...
def _arestas_tues_dedicadas(
    ...
    """
    Fase 13.3 Rev.3 — ramais dedicados das TUEs.
