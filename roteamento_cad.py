...
def _construir_rede_hibrida(
    ...
    """
    Fase 13.4 Rev.11 — rede distribuída por caixas octogonais.
...
# ============================================================
# FASE 13.4 REV.11 — REDISTRIBUIÇÃO FÍSICA AUTOMÁTICA
# ============================================================
...
def _redistribuir_tronco_caixas_octogonais(
    ...
    """
    Fecha o ciclo da Fase 13.4 Rev.11:
...
def _arestas_tues_dedicadas(
    ...
    """
    Fase 13.4 Rev.11 — ramais dedicados das TUEs.
