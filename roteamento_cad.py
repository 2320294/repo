...
def _construir_rede_hibrida(
    ...
    """
    Fase 13.4 Rev.10 — rede distribuída por caixas octogonais.
...
# ============================================================
# FASE 13.4 REV.10 — REDISTRIBUIÇÃO FÍSICA AUTOMÁTICA
# ============================================================
...
def _redistribuir_tronco_caixas_octogonais(
    ...
    """
    Fecha o ciclo da Fase 13.4 Rev.10:
...
def _arestas_tues_dedicadas(
    ...
    """
    Fase 13.4 Rev.10 — ramais dedicados das TUEs.
