...
def _construir_rede_hibrida(
    ...
    """
    Fase 13.6 Rev.122 — rede distribuída por caixas octogonais.
...
def _redistribuir_tronco_caixas_octogonais(
    ...
    """
    Fecha o ciclo da Fase 13.6 Rev.122:
...
def _propagar_circuitos_para_luminarias_secundarias(
    ...
    """
    Fase 13.6 Rev.122 — coerência física de circuitos nos pontos de luz.
...
def _arestas_tugs_internas(
    ...
    for ambiente, interruptores_reg in ints_por_ambiente.items():
        ...
        if len(pontos_int) == 1:
            ...
            # Regra three-way Rev.122 — topologia residencial preferencial.
...
def _arestas_tues_dedicadas(
    ...
    """
    Fase 13.6 Rev.122 — ramais dedicados das TUEs.
...
def _agrupar_arestas_coincidentes_rev116(arestas):
    ...
    A Rev.122 pode ter, no mesmo trecho geométrico, condutores de comando da
...
def desenhar_rotas_qdc_iluminacao(
    ...
    # Fase 13.6 Rev.122 — circuitos terminais que partem de uma
    ...
    # Rev.122: um eletroduto físico deve aparecer UMA vez mesmo quando
    ...
    for indice, trecho in enumerate(
        ...
        rotas.append({
            ...
            "entidade":
                tipo_entidade,
            # Fase 13.6 Rev.122 — referência da entidade física real.
