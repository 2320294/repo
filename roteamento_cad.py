...
def _construir_rede_hibrida(
    ...
    """
    Fase 13.4 Rev.12 — rede distribuída por caixas octogonais.
...
# ============================================================
# FASE 13.4 REV.12 — REDISTRIBUIÇÃO FÍSICA AUTOMÁTICA
# ============================================================
...
def _redistribuir_tronco_caixas_octogonais(
    ...
    """
    Fecha o ciclo da Fase 13.4 Rev.12:
...
def _arestas_tues_dedicadas(
    ...
    """
    Fase 13.4 Rev.12 — ramais dedicados das TUEs.
