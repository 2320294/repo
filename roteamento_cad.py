...
def _construir_rede_hibrida(
    ...
    """
    Fase 13.6 Rev.112 — rede distribuída por caixas octogonais.
...
def _redistribuir_tronco_caixas_octogonais(
    ...
    """
    Fecha o ciclo da Fase 13.6 Rev.112:
...
def _arestas_tues_dedicadas(
    ...
    """
    Fase 13.6 Rev.112 — ramais dedicados das TUEs.
...
def desenhar_rotas_qdc_iluminacao(
    ...
    for indice, trecho in enumerate(
        ...
        rotas.append({
            ...
            "entidade":
                tipo_entidade,
            # Fase 13.6 Rev.112 — referência da entidade física real.
