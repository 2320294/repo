...
def _construir_rede_hibrida(
    ...
    """
    Fase 13.2 Rev.1 — rede distribuída por caixas octogonais.
...
# ============================================================
# FASE 13.2 REV.1 — REDISTRIBUIÇÃO FÍSICA AUTOMÁTICA
# ============================================================
...
def _redistribuir_tronco_caixas_octogonais(
    ...
    """
    Fecha o ciclo da Fase 13.2 Rev.1:
...
def _arestas_tues_dedicadas(
    ...
    """
    Fase 13.2 Rev.1 — ramais dedicados das TUEs.
