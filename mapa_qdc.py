...
# ============================================================
# FASE 13.6 REV.102 — PASSAGENS "POR TRÁS" DE TODOS OS APARELHOS
# ============================================================
_QDC_DJ_RECTS = []
...
def desenhar_mapa_fisico_qdc(
    ...
    """
    Fase 13.6 Rev.102 — QDC executivo no CAD.
    ...
    # Fase 13.6 Rev.102 — o unifilar foi retirado do DXF.
    ...
    # Fase 13.6 Rev.102 — padrão modular do QDC.
    ...
    disp_h = 1.60
    margem_x = 1.15
    # Fase 13.6 Rev.102 — painel lateral mais compacto.
    ...
    # Fase 13.6 Rev.102 — enquadramento compacto conforme referência aprovada.
    ...
    # Fase 13.6 Rev.102 — a moldura geral será fechada no final,
    ...
    _text(
        msp,
        "VISTA FRONTAL - DIAGRAMA DE MONTAGEM E LIGACOES | FASE 13.6 REV.102",
        x0 + 0.55,
        y0 - 0.92,
        0.11,
        LT
    ...
    # Fase 13.6 Rev.102 — eixo geométrico único do "miolo" do QDC.
    ...
    # Fase 13.6 Rev.102 — grade vertical equidistante das seis linhas
    ...
    if dg_geoms:
        ...
        # ====================================================
        # FASE 13.6 REV.102 — ENTRADA DA REDE
        # ====================================================
    ...
    if geral_geom:
        ...
        # ----------------------------------------------------
        # FASE 13.6 REV.102 — CONVENÇÃO DE NÓS DE DERIVAÇÃO
        # ----------------------------------------------------
    ...
    # ========================================================
    # FASE 13.6 REV.102 — NEUTRO DOS IDRs PELO 2º BORNE
    # ========================================================
    # Regras:
    ...
    # ========================================================
    # FASE 13.6 REV.102 — GRADE DA SAÍDA FINAL DO QDC
    # ========================================================
    ...
    # ========================================================
    # FASE 13.6 REV.102 — DESTINO FINAL PRÉ-CALCULADO
    # ========================================================
    ...
    for trilho in range(trilhos_circuitos):
        ...
        # Fase 13.6 Rev.102 — SAÍDAS DOS CIRCUITOS
        # ------------------------------------------------------------
        ...
        if circuitos_geom:
            ...
            if desta_fileira:
                ...
                # ====================================================
                # Fase 13.6 Rev.102 — GRADE VERTICAL DINÂMICA DA FILEIRA
                # ====================================================
    ...
    # ========================================================
    # FASE 13.6 REV.102 — NEUTROS PELA DIREITA, POR FONTE
    # ========================================================
    ...
    # ========================================================
    # FASE 13.6 REV.102 — PE INDIVIDUAL POR CIRCUITO
    # ========================================================
    ...
    # ========================================================
    # FASE 13.6 REV.102 — SEGMENTO FINAL NÃO DESTRUTIVO
    # ========================================================
    ...
    # FASE 13.6 REV.102 — SAÍDA FINAL PELA MESMA LÓGICA DOS NÍVEIS
    # ========================================================
    ...
    # ========================================================
    # FASE 13.6 REV.102 — MOLDURA REAL DO DIAGRAMA
    # ========================================================
    ...
    # Fase 13.6 Rev.102 — centralização geométrica real.
    ...
    # Fase 13.6 Rev.102 — limite esquerdo REAL do diagrama.
    ...
    # Painel lateral
    # -------------------------
    # Fase 13.6 Rev.102 — o painel lateral nasce logo após a moldura REAL
    ...
    # Fase 13.6 Rev.102 — alinhamento superior exato entre os dois quadros.
    ...
    # Fase 13.6 Rev.102 — tabela executiva compacta.
    tabela_x1 = px1 + 0.28
    tabela_largura = min(
        7.10,
        max(
    ...
    # Fase 13.6 Rev.102 — dados elétricos que antes ficavam no unifilar
    # passam para o próprio diagrama de montagem.
    # Fase 13.6 Rev.102 — DADOS DO QUADRO logo abaixo da legenda.
    ...
    # Fase 13.6 Rev.102 — fechamento compacto do painel lateral.
    ...
    # Fase 13.6 Rev.102 — moldura geral dinâmica.
