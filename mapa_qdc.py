...
# ============================================================
# FASE 13.6 REV.35 — PASSAGENS "POR TRÁS" DOS DISJUNTORES
# ============================================================
_QDC_DJ_RECTS = []
...
def desenhar_mapa_fisico_qdc(
    ...
    """
    Fase 13.6 Rev.35 — QDC executivo no CAD.
    ...
    # Fase 13.6 Rev.35 — padrão modular do QDC.
    ...
    _text(
        msp,
        "VISTA FRONTAL - DIAGRAMA DE MONTAGEM E LIGACOES | FASE 13.6 REV.35",
        x0 + 0.55,
        y0 - 0.92,
        0.11,
        LT
    ...
    # Fase 13.6 Rev.35 — eixo geométrico único do "miolo" do QDC.
    ...
    # Fase 13.6 Rev.35 — grade vertical equidistante das seis linhas
    ...
    if dg_geoms:
        ...
        # ====================================================
        # FASE 13.6 REV.35 — ENTRADA DA REDE
        # ====================================================
    ...
    if geral_geom:
        ...
        # ----------------------------------------------------
        # FASE 13.6 REV.35 — CONVENÇÃO DE NÓS DE DERIVAÇÃO
        # ----------------------------------------------------
    ...
    # ========================================================
    # FASE 13.6 REV.35 — NEUTRO DOS IDRs PELO 2º BORNE
    # ========================================================
    # Regras:
    ...
    for trilho in range(trilhos_circuitos):
        ...
        # Fase 13.6 Rev.35 — SAÍDAS DOS CIRCUITOS
        # ------------------------------------------------------------
        ...
        if circuitos_geom:
            ...
            if desta_fileira:
                ...
                # ====================================================
                # Fase 13.6 Rev.35 — GRADE VERTICAL DINÂMICA DA FILEIRA
                # ====================================================
                    ...
                    if fonte_geom and fonte_disp:
                        ...
                        if usar_pente:
                            ...
                            for idx_fase, fase_item in enumerate(
                                ...
                                # Rev.35 — nós por TOPOLOGIA real.
                                #
                                # 1) ponto intermediário da pista:
                                #    horizontal continua para os dois lados e
                                #    existe descida para DJ -> sempre é derivação.
                                #
                                # 2) ponto extremo onde a ALIMENTAÇÃO da fonte
                                #    chega à pista:
                                #    existe tronco vertical + continuidade
                                #    horizontal + descida para DJ -> também é
                                #    uma derivação real e precisa de bolinha.
                                #
                                # 3) extremo oposto, onde há apenas
                                #    horizontal -> vertical para o último DJ:
                                #    é somente curva/terminação -> sem bolinha.
                                for x_no in pontos_destino_fase:
                                    ...
                                    # O extremo alimentado é exatamente aquele
                                    # escolhido como x_destino_fase.
