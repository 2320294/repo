...
# ============================================================
# FASE 13.6 REV.34 — PASSAGENS "POR TRÁS" DOS DISJUNTORES
# ============================================================
_QDC_DJ_RECTS = []
...
def desenhar_mapa_fisico_qdc(
    ...
    """
    Fase 13.6 Rev.34 — QDC executivo no CAD.
    ...
    # Fase 13.6 Rev.34 — padrão modular do QDC.
    ...
    _text(
        msp,
        "VISTA FRONTAL - DIAGRAMA DE MONTAGEM E LIGACOES | FASE 13.6 REV.34",
        x0 + 0.55,
        y0 - 0.92,
        0.11,
        LT
    ...
    # Fase 13.6 Rev.34 — eixo geométrico único do "miolo" do QDC.
    ...
    # Fase 13.6 Rev.34 — grade vertical equidistante das seis linhas
    ...
    if dg_geoms:
        ...
        # ====================================================
        # FASE 13.6 REV.34 — ENTRADA DA REDE
        # ====================================================
    ...
    if geral_geom:
        ...
        # ----------------------------------------------------
        # FASE 13.6 REV.34 — CONVENÇÃO DE NÓS DE DERIVAÇÃO
        # ----------------------------------------------------
    ...
    # ========================================================
    # FASE 13.6 REV.34 — NEUTRO DOS IDRs PELO 2º BORNE
    # ========================================================
    # Regras:
    ...
    for trilho in range(trilhos_circuitos):
        ...
        # Fase 13.6 Rev.34 — SAÍDAS DOS CIRCUITOS
        # ------------------------------------------------------------
        ...
        if circuitos_geom:
            ...
            if desta_fileira:
                ...
                # ====================================================
                # Fase 13.6 Rev.34 — GRADE VERTICAL DINÂMICA DA FILEIRA
                # ====================================================
                    ...
                    if fonte_geom and fonte_disp:
                        ...
                        if usar_pente:
                            ...
                            for idx_fase, fase_item in enumerate(
                                ...
                                # Rev.34 — nó SOMENTE em ramificação real.
                                #
                                # Um ponto na extremidade esquerda OU direita
                                # da pista é apenas terminação/curva do cabo:
                                # horizontal -> vertical. Não recebe bolinha.
                                #
                                # Só um ponto estritamente INTERMEDIÁRIO possui
                                # continuidade horizontal dos dois lados +
                                # derivação vertical, portanto recebe o nó.
