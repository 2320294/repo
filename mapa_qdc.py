...
# ============================================================
# FASE 13.6 REV.120 — PASSAGENS "POR TRÁS" DE TODOS OS APARELHOS
# ============================================================
_QDC_DJ_RECTS = []
...
def desenhar_mapa_fisico_qdc(
    ...
    """
    Fase 13.6 Rev.124 — QDC executivo no CAD.
    ...
    # Fase 13.6 Rev.124 — o unifilar foi retirado do DXF.
    ...
    # Fase 13.6 Rev.124 — padrão modular do QDC.
    ...
    disp_h = 1.60
    margem_x = 1.15
    # Fase 13.6 Rev.124 — painel lateral e tabela com largura automática.
    ...
    # Rev.124 — a coluna Ambientes usa a largura GRÁFICA efetiva da fonte,
    ...
    def _largura_texto_grafica_rev120(texto, altura_texto):
        texto = str(texto or "-")
        try:
    ...
    largura_ambientes_necessaria_rev120 = _largura_texto_grafica_rev120(
        "Ambientes", 0.075
    )
    for _amb_rev120 in (_ambs_rev117 or ["-"]):
        largura_ambientes_necessaria_rev120 = max(
            largura_ambientes_necessaria_rev120,
            _largura_texto_grafica_rev120(_amb_rev120, 0.066),
        )

    # 0,38 = folga total de célula (margem esquerda + margem direita).
    # A margem é propositalmente maior que na Rev.124 para que a última letra
    # nunca fique colada à borda vertical da tabela.
    col_ambientes_auto_rev117 = max(
        1.45,
        largura_ambientes_necessaria_rev120 + 0.38,
    )
    ...
    # Fase 13.6 Rev.124 — enquadramento compacto conforme referência aprovada.
    ...
    # Fase 13.6 Rev.124 — a moldura geral será fechada no final,
    ...
    # Fase 13.6 Rev.124 — eixo geométrico único do "miolo" do QDC.
    ...
    # Fase 13.6 Rev.124 — grade vertical equidistante das seis linhas
    ...
    if dg_geoms:
        ...
        # ====================================================
        # FASE 13.6 REV.120 — ENTRADA DA REDE
        # ====================================================
    ...
    if geral_geom:
        ...
        # ----------------------------------------------------
        # FASE 13.6 REV.120 — CONVENÇÃO DE NÓS DE DERIVAÇÃO
        # ----------------------------------------------------
    ...
    # ========================================================
    # FASE 13.6 REV.120 — NEUTRO DOS IDRs PELO 2º BORNE
    # ========================================================
    # Regras:
    ...
    # ========================================================
    # FASE 13.6 REV.120 — DESTINO FINAL PRÉ-CALCULADO
    # ========================================================
    ...
    for trilho in range(trilhos_circuitos):
        ...
        # Fase 13.6 Rev.124 — SAÍDAS DOS CIRCUITOS
        # ------------------------------------------------------------
        ...
        if circuitos_geom:
            ...
            if desta_fileira:
                ...
                # ====================================================
                # Fase 13.6 Rev.124 — GRADE VERTICAL DINÂMICA DA FILEIRA
                # ====================================================
    ...
    # ========================================================
    # FASE 13.6 REV.120 — NEUTROS PELA DIREITA, POR FONTE
    # ========================================================
    ...
    # ========================================================
    # FASE 13.6 REV.120 — PE INDIVIDUAL POR CIRCUITO
    # ========================================================
    ...
    # ========================================================
    # FASE 13.6 REV.120 — SEGMENTO FINAL NÃO DESTRUTIVO
    # ========================================================
    ...
    # FASE 13.6 REV.120 — SAÍDA FINAL PELA MESMA LÓGICA DOS NÍVEIS
    # ========================================================
    ...
    # ========================================================
    # FASE 13.6 REV.120 — MOLDURA REAL DO DIAGRAMA
    # ========================================================
    ...
    # Fase 13.6 Rev.124 — centralização geométrica real.
    ...
    # Fase 13.6 Rev.124 — limite esquerdo REAL do diagrama.
    ...
    # Fase 13.6 Rev.124 — limite direito REAL do diagrama.
    ...
    # Painel lateral
    # -------------------------
    # Fase 13.6 Rev.124 — o painel lateral nasce logo após a moldura REAL
    ...
    # Fase 13.6 Rev.124 — alinhamento superior exato entre os dois quadros.
    ...
    # Fase 13.6 Rev.124 — tabela executiva realmente automática.
    ...
    # Fase 13.6 Rev.124 — dados elétricos que antes ficavam no unifilar
    # passam para o próprio diagrama de montagem.
    # Fase 13.6 Rev.124 — DADOS DO QUADRO logo abaixo da legenda.
    ...
    # Fase 13.6 Rev.124 — fechamento compacto do painel lateral.
    ...
    # Fase 13.6 Rev.124 — moldura geral dinâmica.
