...
def desenhar_mapa_fisico_qdc(
    ...
    """
    Fase 13.6 Rev.120 — QDC executivo no CAD.
    ...
    # Fase 13.6 Rev.120 — o unifilar foi retirado do DXF.
    ...
    # Fase 13.6 Rev.120 — padrão modular do QDC.
    ...
    disp_h = 1.60
    margem_x = 1.15
    # Fase 13.6 Rev.120 — painel lateral e tabela com largura automática.
    ...
    # Rev.120 — a coluna Ambientes usa a largura GRÁFICA efetiva da fonte,
    ...
    # A margem é propositalmente maior que na Rev.120 para que a última letra
    ...
    # Fase 13.6 Rev.120 — enquadramento compacto conforme referência aprovada.
    ...
    # Fase 13.6 Rev.120 — a moldura geral será fechada no final,
    ...
    # Fase 13.6 Rev.120 — eixo geométrico único do "miolo" do QDC.
    ...
    # Fase 13.6 Rev.120 — grade vertical equidistante das seis linhas
    ...
    for trilho in range(trilhos_circuitos):
        ...
        # Fase 13.6 Rev.120 — SAÍDAS DOS CIRCUITOS
        # ------------------------------------------------------------
        ...
        if circuitos_geom:
            ...
            if desta_fileira:
                ...
                # ====================================================
                # Fase 13.6 Rev.120 — GRADE VERTICAL DINÂMICA DA FILEIRA
                # ====================================================
    ...
    # Fase 13.6 Rev.120 — centralização geométrica real.
    ...
    # Fase 13.6 Rev.120 — limite esquerdo REAL do diagrama.
    ...
    # Fase 13.6 Rev.120 — limite direito REAL do diagrama.
    ...
    # Painel lateral
    # -------------------------
    # Fase 13.6 Rev.120 — o painel lateral nasce logo após a moldura REAL
    ...
    # Fase 13.6 Rev.120 — alinhamento superior exato entre os dois quadros.
    ...
    # Fase 13.6 Rev.120 — tabela executiva realmente automática.
    ...
    # Fase 13.6 Rev.120 — dados elétricos que antes ficavam no unifilar
    # passam para o próprio diagrama de montagem.
    # Fase 13.6 Rev.120 — DADOS DO QUADRO logo abaixo da legenda.
    ...
    # Fase 13.6 Rev.120 — fechamento compacto do painel lateral.
    ...
    # Fase 13.6 Rev.120 — moldura geral dinâmica.
