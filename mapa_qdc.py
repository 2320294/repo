...
def desenhar_mapa_fisico_qdc(
    ...
    """
    Fase 13.6 Rev.123 — QDC executivo no CAD.
    ...
    # Fase 13.6 Rev.123 — o unifilar foi retirado do DXF.
    ...
    # Fase 13.6 Rev.123 — padrão modular do QDC.
    ...
    disp_h = 1.60
    margem_x = 1.15
    # Fase 13.6 Rev.123 — painel lateral e tabela com largura automática.
    ...
    # Rev.123 — a coluna Ambientes usa a largura GRÁFICA efetiva da fonte,
    ...
    # A margem é propositalmente maior que na Rev.123 para que a última letra
    ...
    # Fase 13.6 Rev.123 — enquadramento compacto conforme referência aprovada.
    ...
    # Fase 13.6 Rev.123 — a moldura geral será fechada no final,
    ...
    # Fase 13.6 Rev.123 — eixo geométrico único do "miolo" do QDC.
    ...
    # Fase 13.6 Rev.123 — grade vertical equidistante das seis linhas
    ...
    for trilho in range(trilhos_circuitos):
        ...
        # Fase 13.6 Rev.123 — SAÍDAS DOS CIRCUITOS
        # ------------------------------------------------------------
        ...
        if circuitos_geom:
            ...
            if desta_fileira:
                ...
                # ====================================================
                # Fase 13.6 Rev.123 — GRADE VERTICAL DINÂMICA DA FILEIRA
                # ====================================================
    ...
    # Fase 13.6 Rev.123 — centralização geométrica real.
    ...
    # Fase 13.6 Rev.123 — limite esquerdo REAL do diagrama.
    ...
    # Fase 13.6 Rev.123 — limite direito REAL do diagrama.
    ...
    # Painel lateral
    # -------------------------
    # Fase 13.6 Rev.123 — o painel lateral nasce logo após a moldura REAL
    ...
    # Fase 13.6 Rev.123 — alinhamento superior exato entre os dois quadros.
    ...
    # Fase 13.6 Rev.123 — tabela executiva realmente automática.
    ...
    # Fase 13.6 Rev.123 — dados elétricos que antes ficavam no unifilar
    # passam para o próprio diagrama de montagem.
    # Fase 13.6 Rev.123 — DADOS DO QUADRO logo abaixo da legenda.
    ...
    # Fase 13.6 Rev.123 — fechamento compacto do painel lateral.
    ...
    # Fase 13.6 Rev.123 — moldura geral dinâmica.
