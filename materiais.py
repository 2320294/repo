...
def renderizar_materiais(
    ...
    if resumo_drs:
        ...
        st.caption(
            "Fase 10.4: corrente nominal pré-dimensionada pelo maior "
    ...
    with col_excel:
        st.download_button(
            "📊 Exportar para Excel",
            data=excel_bytes,
            file_name=f"{nome_arquivo}_Circuitos_Materiais_Fase_10_4.xlsx",
    ...
    with col_pdf:
        st.download_button(
            "📄 Gerar PDF",
            data=pdf_bytes,
            file_name=f"{nome_arquivo}_Circuitos_Materiais_Fase_10_4.pdf",
