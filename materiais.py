...
def calcular_quantitativo_materiais(
    ...
    for row in tabela_editada:
        ...
        # ========================================================
    # FASE 11.5 — FORMAÇÃO DEFINITIVA DOS CIRCUITOS
    # ========================================================
    # A estimativa geométrica de cabos/eletrodutos continua baseada nas
    # cargas elementares por ambiente até a Fase 11.5/11.2, quando o
...
def _dataframes_materiais_circuitos(materiais, circuitos):
    ...
    if not circuitos_df.empty:
        ...
        # Fase 11.5: dados estruturais usados pelo roteamento continuam
...
def renderizar_materiais(
    ...
    if resumo_drs:
        ...
        st.caption(
            "Fase 11.5: corrente nominal pré-dimensionada pelo maior "
    ...
    st.caption(
        "Fase 11.5: os circuitos abaixo já são consolidados. "
    ...
    with col_excel:
        st.download_button(
            "📊 Exportar para Excel",
            data=excel_bytes,
            file_name=f"{nome_arquivo}_Circuitos_Materiais_Fase_11_5.xlsx",
    ...
    with col_pdf:
        st.download_button(
            "📄 Gerar PDF",
            data=pdf_bytes,
            file_name=f"{nome_arquivo}_Circuitos_Materiais_Fase_11_5.pdf",
