...
# ============================================================
# FASE 13.4 REV.7 — QDC EXECUTIVO / QUANTITATIVO DERIVADO DO UNIFILAR
# ============================================================
...
def _auditar_consistencia_qdc(
    ...
    """
    Fase 13.4 Rev.7 — auditoria cruzada do QDC.
...
def calcular_quantitativo_materiais(
    ...
    for row in tabela_editada:
        ...
        # ========================================================
    # FASE 13.4 REV.7 — FORMAÇÃO DEFINITIVA DOS CIRCUITOS
    # ========================================================
    # A estimativa geométrica de cabos/eletrodutos continua baseada nas
    # cargas elementares por ambiente até a Fase 13.4 Rev.7/11.2, quando o
    ...
    # Fase 13.4 Rev.7 — se o CAD desta versão já calculou correções por
...
# ========================================================
    ...
    # ========================================================
    # FASE 13.4 REV.7 — COMPRIMENTOS REAIS DERIVADOS DO ROTEAMENTO FÍSICO
    # ========================================================
    if (
        isinstance(
            resumo_rotas,
    ...
    # ========================================================
    # FASE 13.4 REV.7 — FILTRO EXECUTIVO: SOMENTE QUANTIDADES DO PROJETO
    # ========================================================
...
def _dataframes_materiais_circuitos(materiais, circuitos):
    ...
    if not circuitos_df.empty:
        ...
        # Fase 13.4 Rev.7: dados estruturais usados pelo roteamento continuam
...
def renderizar_materiais(
    ...
    # Fase 13.4 Rev.7 — componentes físicos do QDC derivados do unifilar.
    ...
    # ========================================================
    # FASE 13.4 REV.7 — APRESENTAÇÃO MODULAR
    # ========================================================
    ...
    with col_excel:
        st.download_button(
            "📊 Exportar para Excel",
            data=excel_bytes,
            file_name=f"{nome_arquivo}_Circuitos_Materiais_Fase_13_4_Rev_7.xlsx",
    ...
    with col_pdf:
        st.download_button(
            "📄 Gerar PDF",
            data=pdf_bytes,
            file_name=f"{nome_arquivo}_Circuitos_Materiais_Fase_13_4_Rev_7.pdf",
