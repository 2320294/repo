...
def _auditar_consistencia_qdc(
    ...
    """
    Fase 13.6 Rev.33 — auditoria cruzada do QDC.
...
def calcular_quantitativo_materiais(
    ...
    # cargas elementares por ambiente até a Fase 13.6 Rev.33/11.2, quando o
    ...
    # Fase 13.6 Rev.33 — se o CAD desta versão já calculou correções por
...
def _dataframes_materiais_circuitos(materiais, circuitos):
    ...
    if not circuitos_df.empty:
        ...
        # Fase 13.6 Rev.33: dados estruturais usados pelo roteamento continuam
...
def renderizar_materiais(
    ...
    # Fase 13.6 Rev.33 — componentes físicos do QDC derivados do unifilar.
    ...
    with col_excel:
        st.download_button(
            "📊 Exportar para Excel",
            data=excel_bytes,
            file_name=f"{nome_arquivo}_Circuitos_Materiais_Fase_13_6_Rev_33.xlsx",
    ...
    with col_pdf:
        st.download_button(
            "📄 Gerar PDF",
            data=pdf_bytes,
            file_name=f"{nome_arquivo}_Circuitos_Materiais_Fase_13_6_Rev_33.pdf",
