...
def _auditar_consistencia_qdc(
    ...
    """
    Fase 13.6 Rev.124 — auditoria cruzada do QDC.
...
def calcular_quantitativo_materiais(
    ...
    # cargas elementares por ambiente até a Fase 13.6 Rev.124/11.2, quando o
    ...
    # Fase 13.6 Rev.124 — se o CAD desta versão já calculou correções por
...
def _dataframes_materiais_circuitos(materiais, circuitos):
    ...
    if not circuitos_df.empty:
        ...
        # Fase 13.6 Rev.124: dados estruturais usados pelo roteamento continuam
