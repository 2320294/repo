...
def validar_eletrica_rotas(
    ...
    """
    Validação preliminar da Fase 13.6 Rev.10.
...
def verificar_capacidade_conducao_preliminar(
    ...
    """Fase 13.6 Rev.10: verifica a capacidade trecho a trecho e identifica o trecho crítico."""
...
def otimizar_eletrodutos_preliminar(
    ...
    return {
        ...
        "observacao": (
            ...
            "redistribuição por outra caixa octogonal; a Fase 13.6 Rev.10 também passa "
