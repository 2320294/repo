...
def _condutores_circuito_rota(circuito, rota):
    """Rev.119: composição de condutores dependente da função física do trecho.
    ...
    if tipo == "ILUMINAÇÃO".upper():
        ...
        if criterio == "LUZ_PARA_INTERRUPTOR_PARALELO_2":
            # Rev.119: segundo paralelo também sai diretamente da caixa da
        ...
        if criterio == "INTERRUPTOR_PARA_LUZ_PARALELO_2":
            # Compatibilidade com projetos/rotas gravados na Rev.115.
            return [
                {"funcao": "Retorno", "cor": "Preto", "bitola_mm2": bitola},
            ]
...
def validar_eletrica_rotas(
    ...
    """
    Validação preliminar da Fase 13.6 Rev.119.
...
def verificar_capacidade_conducao_preliminar(
    ...
    """Fase 13.6 Rev.119: verifica a capacidade trecho a trecho e identifica o trecho crítico."""
...
def otimizar_eletrodutos_preliminar(
    ...
    return {
        ...
        "observacao": (
            ...
            "redistribuição por outra caixa octogonal; a Fase 13.6 Rev.119 também passa "
