...
def _condutores_circuito_rota(circuito, rota):
    """Rev.121: composição de condutores dependente da função física do trecho.
    ...
    if tipo == "ILUMINAÇÃO".upper():
        ...
        if criterio == "LUZ_PARA_INTERRUPTOR_PARALELO_2":
            # Rev.121: segundo paralelo também sai diretamente da caixa da
...
def validar_eletrica_rotas(
    ...
    """
    Validação preliminar da Fase 13.6 Rev.121.
...
def verificar_capacidade_conducao_preliminar(
    ...
    """Fase 13.6 Rev.121: verifica a capacidade trecho a trecho e identifica o trecho crítico."""
...
def otimizar_eletrodutos_preliminar(
    ...
    return {
        ...
        "observacao": (
            ...
            "redistribuição por outra caixa octogonal; a Fase 13.6 Rev.121 também passa "
