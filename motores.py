...
def gerar_cad_unifilar(
    ...
    try:
        ...
        for polilinha in polilinhas:
            ...
            # Fase 13.4 Rev.12 — a geometria do ambiente só pode ser
        ...
        # ====================================================
        # FASE 13.4 REV.12 — REDE TRONCAL HÍBRIDA + TODAS AS LUMINÁRIAS
        # ====================================================
        ...
        # ====================================================
        # FASE 13.4 REV.12 — DIMENSIONAMENTO ITERATIVO AUTOMÁTICO
        # ====================================================
