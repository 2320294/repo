...
def gerar_cad_unifilar(dxf_bytes, dados_editados, local_qdc):
    ...
    try:
        ...
        for polilinha in polilinhas:
            ...
            # 1. Distribuição de Luz e Interruptor Inteligente (15cm, lado oposto à dobradiça, tangenciando a parede para dentro)
            if nome in dict_dados:
                ...
                if qtd_ilum > 0:
                    ...
                    # POSICIONAMENTO DO INTERRUPTOR (15cm da ponta oposta à dobradiça, tangenciando parede para dentro)
                    ...
                    if unique_portas and logical_walls:
                        ...
                        # Fixa na ponta do vão do lado oposto à dobradiça (garantindo o alinhamento correto)
            ...
            if nome in dict_dados:
                ...
                qtd_tue = int(dict_dados[nome]['TQtd TUE'] if 'TQtd TUE' in dict_dados[nome] else dict_dados[nome]['Qtd TUE'])
