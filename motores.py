        ...
        if nome in dict_dados:
            ...
            if qtd_ilum > 0:
                ...
                if unique_portas and logical_walls:
                    ...
                    ponto_batente_oposto = pt_porta_2 if d1 < d2 else pt_porta_1
        ...
        if nome in dict_dados:
            ...
            if total_tugs > 0 and comp_total > 0:
                ...
                for i in range(total_tugs):
                    ...
                    # Encontra o vetor normal interno (para dentro do ambiente) para este segmento de parede
                    nx, ny = get_inside_normal(seg_vx, seg_vy, px, py, centro_x, centro_y)
                    
                    # Alinha a base da tomada encostada na parede pelo lado interior
                    # Deslocamos o símbolo levemente para dentro usando o vetor normal (nx, ny) de modo que a base tangencie a face interna
                    t_x = px + (nx * 0.10)
                    t_y = py + (ny * 0.10)
